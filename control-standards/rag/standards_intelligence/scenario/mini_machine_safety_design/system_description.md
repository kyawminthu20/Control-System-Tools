...
| HMI / UI                       | Start, stop, reset, mode selection, alarm display, process values, maintenance screens.                          | Accidental actuation, unclear status, misuse of touchscreen for safety.      | HMI shall not be the sole emergency-stop means, and hazardous-motion start commands shall be guarded or recessed. [LOCAL: us/nfpa79/NFPA79_2024__Ch10__operator_interface_devices.md#2-ergonomics-and-safety] [LOCAL: international/machinery/iec_60204_1/IEC60204_1_2018__Clause10__operator_interface.md#2-ergonomic-considerations]                            |
| Network and logger             | PLC communications, HMI communications, optional historian or edge logger, time source.                          | Cyber-induced unsafe state, loss of records, unsafe writes into safety path. | Safety communications may use certified black-channel protocols; cybersecurity segmentation and audit-trail rigor are NOT FOUND IN LOCAL CORPUS – TO VERIFY. [LOCAL: international/machinery/iec_60204_1/IEC60204_1_2018__Clause09__control_circuits_and_functions.md#3-safety-vs-standard-control-separation] [TO VERIFY: IEC 62443] [TO VERIFY: NIST SP 800-82] |

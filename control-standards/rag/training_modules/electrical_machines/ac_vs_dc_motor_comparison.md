...
MODULE_ID: ac_vs_dc_motor_comparison
LEARNING_LEVEL: intermediate

INDEX_TAGS:
  topics: ["ac_motor", "dc_motor", "induction_motor", "brushed_dc", "motor_comparison"]
...
- [DC Motor Basics](./dc_motor_basics.md)
- [Induction Motor Basics](./induction_motor_basics.md)

...
INDEX_TAGS:
  topics: ["bldc", "pmsm", "implementation", "drive_selection", "motor_selection", "foc", "six_step", "inverter", "mosfet", "igbt", "measurement", "commissioning", "wiring", "failure_modes", "checklist"]
  systems: ["motor_drive", "servo", "machine", "power_electronics"]
-->

# BLDC and PMSM Implementation Guide
...
## 3. BLDC vs PMSM — Deep Comparison
...
## 5. Mathematical Foundation (Practical)
...
## 9. Hobby vs Industrial Comparison
...
## 12. Practical Implementation Scenarios

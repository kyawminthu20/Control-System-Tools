...
INDEX_TAGS:
  topics: ["motor_selection", "scenarios", "bldc", "pmsm", "foc", "sensorless", "servo", "agv", "fan_pump", "wafer_stage", "drive_selection", "wiring", "tuning", "measurement"]
  systems: ["motor_drive", "servo", "machine"]
-->

# Motor Selection Scenarios — Fan/Pump, Precision Axis, AGV
...
## 2. Scenario 1 — BLDC-favored: High-Speed Cooling Fan / Pump System

### 2.1 System context and requirements
...
### 2.2 Engineering analysis and recommended solution
...
### 2.7 Control strategy — sensorless 6-step with optional Hall
...
### 2.14 Final engineering verdict
...
### 3.1 System context and requirements
...
### 3.2 Engineering analysis and recommended solution
...
### 3.4 Why PMSM wins and why BLDC is not suitable
...
### 3.7 Control strategy — full servo stack with FOC
...
### 3.14 Final engineering verdict
...
### 4.7 Two competing architectures

#### 4.7.1 Option A — BLDC (cost-optimized)
...
#### 4.7.2 Option B — PMSM (performance-optimized)
...
### 4.9 Real engineering trade-flip
...
### 4.13 Cost vs experience tradeoff
...
### 4.14 Final engineering verdict
...
### 5.2 Wiring comparison across the three archetypes

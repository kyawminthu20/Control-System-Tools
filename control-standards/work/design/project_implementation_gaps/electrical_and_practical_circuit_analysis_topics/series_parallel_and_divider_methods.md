...
This is a cleaned work note derived from the early worked-example portion of `electrical and practical circuit analysis.md` (raw source note removed from the repository).

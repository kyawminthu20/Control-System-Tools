I generated a **full diagram reference pack** in the canvas for the project.
...
It includes **34 Mermaid diagrams**, covering:

- site information architecture
- directory navigation
- standards relationship graph
- machinery vs process routing
- SIL vs PL concept map
- full lifecycle with standards overlay
- deliverables map
- 7-layer machine architecture
- standard vs safety control separation
- safety function chains
- 1oo1 / 1oo2 / 2oo3 comparison
- detailed design and part sizing
- electrical design route
- documentation stack
- software stack
- cybersecurity overlay
- installation / pre-commissioning / calibration
- commissioning / validation
- maintenance lifecycle
- industry navigator
- semiconductor / US panel / global machine / process skid examples
- scenario explorer
...
Do not treat all 34 as equal.

### Start with these first

1. Lifecycle flow
2. Standards relationship graph
3. Machinery vs process routing
4. 7-layer architecture
5. Standard control vs safety control separation
6. Industry matrix navigator
7. Software stack architecture
8. Commissioning workflow
9. Maintenance loop
10. Interview answer logic

Those 10 will carry most of the value.

## Important caution

Mermaid is good for **conceptual diagrams**, but not for:
...
For those, use **SVG/draw.io/Figma/Visio-style redraws** later.

## Best workflow

Use this pack as:

- **source-of-truth conceptual diagrams**
- then convert the most important ones into polished SVGs for the public site

Next step should be to classify them into:

- **homepage diagrams**
- **standards section diagrams**
- **lifecycle section diagrams**
- **industry/scenario diagrams**

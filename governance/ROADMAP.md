...
| Phase | Program | Why |
|---|---|---|
| 42 | **Troubleshooting engine** — fill the empty corpus module + site decision trees (VFD faults, analog loop faults, "motor won't start", comms dropouts) | Field pattern-recognition is the least Google-able knowledge here |

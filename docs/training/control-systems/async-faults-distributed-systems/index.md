...
- [Machine State Model]({{ '/training/control-systems/machine-state-model/' | relative_url }}) — the FAULT state and recovery transitions
- [Interlocks, Permissives & Safety Trips]({{ '/training/control-systems/interlocks-permissives-safety-trips/' | relative_url }}) — the protective layers that generate faults
- [Deterministic vs Non-Deterministic Control]({{ '/training/control-systems/deterministic-nondeterministic-control/' | relative_url }}) — why timing matters in distributed fault detection

...
- [Machine State Model]({{ '/training/control-systems/machine-state-model/' | relative_url }}) — where interlocks and permissives fit in the state machine
- [Async Faults in Distributed Systems]({{ '/training/control-systems/async-faults-distributed-systems/' | relative_url }}) — how faults propagate across networked devices

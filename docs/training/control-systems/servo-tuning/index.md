...
- [Control Loop Architectures]({{ '/training/control-systems/control-loop-architectures/' | relative_url }}) — how servo loops fit into broader control architecture
- [Vibration and Resonance]({{ '/training/control-systems/vibration-resonance/' | relative_url }}) — physical causes and mechanical mitigation
- [Multi-Axis Coordination]({{ '/training/control-systems/multi-axis-coordination/' | relative_url }}) — applying tuned axes to coordinated motion

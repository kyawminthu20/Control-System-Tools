...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/training/control-systems/pid-foundation/' | relative_url }}">&larr; PID Control — Intuitive Foundation</a>
  <a href="{{ '/training/control-systems/' | relative_url }}">↑ Control Systems</a>
  <a href="{{ '/training/control-systems/industrial-pid/' | relative_url }}">Industrial PID Implementation &rarr;</a>
</div>

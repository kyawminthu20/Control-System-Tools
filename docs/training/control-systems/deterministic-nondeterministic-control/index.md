...
- [Async Faults in Distributed Systems]({{ '/training/control-systems/async-faults-distributed-systems/' | relative_url }}) — timing and detection in networked control
- [Control Theory Overview]({{ '/training/control-systems/control-theory-overview/' | relative_url }}) — how control loop timing relates to stability

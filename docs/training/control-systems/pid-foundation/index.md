...
| --- | --- | --- |
| [PID Intuition]({{ '/training/control-systems/pid-intuition/' | relative_url }}) | feedback basics and PID intuition | the mental model first |
| [Industrial PID Implementation]({{ '/training/control-systems/industrial-pid/' | relative_url }}) | PLC-style signals, bias, limits, sample time, Rockwell, Siemens | the controller as it appears in real platforms |
| [Control Loop Architectures]({{ '/training/control-systems/control-loop-architectures/' | relative_url }}) | PI vs PID, VFD speed loops, servo loops, process loops | context for how loops are arranged in machines |
| [PID Heater Control]({{ '/training/control-systems/pid-heater-control/' | relative_url }}) | PI plus time-proportioning, minimum on/off time, safety logic, state machine | a real heater-control design with binary output hardware |
...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/training/control-systems/control-theory-overview/' | relative_url }}">&larr; Control Theory Overview</a>
  <a href="{{ '/training/control-systems/' | relative_url }}">↑ Control Systems</a>
  <a href="{{ '/training/control-systems/pid-intuition/' | relative_url }}">PID Intuition — P, I, and D in Practice &rarr;</a>
</div>

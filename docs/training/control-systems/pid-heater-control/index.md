...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/training/control-systems/control-loop-architectures/' | relative_url }}">&larr; Control Loop Architectures</a>
  <a href="{{ '/training/control-systems/' | relative_url }}">↑ Control Systems</a>
  <a href="{{ '/training/control-systems/pid-drone-control/' | relative_url }}">PID in Drone and Motion Control &rarr;</a>
</div>

...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/training/control-systems/pid-intuition/' | relative_url }}">&larr; PID Intuition</a>
  <a href="{{ '/training/control-systems/' | relative_url }}">↑ Control Systems</a>
  <a href="{{ '/training/control-systems/control-loop-architectures/' | relative_url }}">Control Loop Architectures &rarr;</a>
</div>

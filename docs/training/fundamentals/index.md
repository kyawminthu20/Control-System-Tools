...
description: "8 modules covering electrical quantities, circuit analysis methods, passive components, switching devices, and conductor sizing."
breadcrumb:
  - name: "Training"
    url: "/training/"
...
<div class="page-header">
  ...
  <p>For engineers and technicians building the circuit vocabulary and analysis skills required across all controls, panel design, and machine work. Start here if you are new to industrial electrical systems.</p>
</div>

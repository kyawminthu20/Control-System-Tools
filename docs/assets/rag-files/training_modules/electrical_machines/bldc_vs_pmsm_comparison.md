...
INDEX_TAGS:
  topics: ["bldc", "pmsm", "motor_selection", "trapezoidal", "sinusoidal", "foc", "torque_ripple", "field_weakening", "decision_matrix", "scenarios"]
  systems: ["motor_drive", "servo", "machine"]
-->

# BLDC vs PMSM — Motors, Drives, and Scenarios
...
# 2. Physical Construction — What Actually Differs
...
# 3. Back-EMF — The Root Cause of All Control Differences
...
# 6. Feedback — Why It Gates Performance
...
# 10. Cost Structure (2026 ballpark, industrial)
...
# 12. Decision Matrix (Use This When Speccing)
...
# 13. Common Field Failure Modes (BLDC vs PMSM-specific)
...
# 14. What the User Should Take Away

...
| Keep official copy | UL 508A | Have locally | `us/ul_508a/` and `_index.yaml` shows `UL_508A_Ed3` as `complete` | [UL 508A](https://www.shopulstandards.com/ProductDetail.aspx?productId=UL508A_3_S_20180424) | USD 350.00 online / USD 698.00 print | Local corpus currently labels this as `2022`; official UL page shows Edition 3 published 2018 and revised 2025, so edition normalization is needed. |

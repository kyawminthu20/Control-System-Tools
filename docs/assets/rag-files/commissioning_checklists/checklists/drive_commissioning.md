...
Use this checklist during first power-up and early verification of a motor-drive system.

Follow site safety procedures and OEM instructions for stored energy, isolation, and enabled motion.
...
- [VFD Commissioning Workflow](../../design_framework/motor_systems/vfd_commissioning_workflow.md)
- [Motor Rotation and Overload Verification](./motor_rotation_and_overload_verification.md)

...
- Same card pattern as `/design/workflows/index.md`
...
- Motor Selection Matrix ← add "Related References" section to `/design/workflows/motor-selection/index.md`
- Machine Architecture Model ← add "Related References" link to `/implementation/scenarios/semiconductor-equipment/index.md`
...
```html
<meta http-equiv="refresh" content="0; url={{ '/implementation/commissioning-templates/' | relative_url }}">
```

...
<nav class="page-nav">
  <a href="{{ '/implementation/lifecycle-build/' | relative_url }}" class="page-nav__prev">← Stage 7: Build</a>
  <a href="{{ '/implementation/lifecycle-pre-commissioning/' | relative_url }}" class="page-nav__next">Stage 9: Pre-Commissioning →</a>
</nav>

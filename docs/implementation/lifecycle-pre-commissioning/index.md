...
redirect_from:
  ...
  - /lifecycle/pre-commissioning/index.html
---
...
<nav class="lifecycle-nav">
  <a href="{{ '/implementation/lifecycle-installation/' | relative_url }}" class="lifecycle-nav__prev">← Stage 8: Installation</a>
  <a href="{{ '/implementation/lifecycle-commissioning/' | relative_url }}" class="lifecycle-nav__next">Stage 10: Commissioning →</a>
</nav>

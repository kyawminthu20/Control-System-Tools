...
- [7-Layer Machine Architecture Model]({{ '/reference/architecture/machine-architecture-model/' | relative_url }})
- [Universal Machine Safety Architecture]({{ '/reference/architecture/machine-safety-architecture/' | relative_url }})

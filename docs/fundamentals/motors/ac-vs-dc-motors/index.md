...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/motors/motor-family-comparison/' | relative_url }}">&larr; Motor Family Comparison</a>
  <a href="{{ '/fundamentals/motors/' | relative_url }}">↑ Motors, Drives, and Motion</a>
  <a href="{{ '/fundamentals/motors/vfd-fundamentals/' | relative_url }}">VFD Fundamentals &rarr;</a>
</div>

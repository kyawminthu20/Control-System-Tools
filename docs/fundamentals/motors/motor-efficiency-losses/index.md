...
review:
  ...
  coverage: "Training module: Motor Efficiency, Power Factor, and Losses — educational treatment; sizing and application decisions follow vendor data and the governing standards."
...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/motors/motor-control-methods/' | relative_url }}">&larr; Motor Control Methods and Operating Regions</a>
  <a href="{{ '/fundamentals/motors/' | relative_url }}">↑ Motors, Drives, and Motion</a>
  <a href="{{ '/fundamentals/motors/motor-vfd-equations/' | relative_url }}">Motor and VFD Equations Reference &rarr;</a>
</div>

...
redirect_from:
  - /training/nec-application/disconnecting-means/
review:
  ...
  coverage: "Training module: Disconnecting Means for Machinery — worked as education, not a code determination; the AHJ and enforceable edition govern."
...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/nec-application/branch-circuits-vs-feeders/' | relative_url }}">&larr; Branch Circuits vs. Feeders</a>
  <a href="{{ '/fundamentals/nec-application/' | relative_url }}">↑ NEC for Machines and Panels</a>
  <a href="{{ '/fundamentals/nec-application/grounding-bonding-panels/' | relative_url }}">Grounding and Bonding for Control Panels &rarr;</a>
</div>

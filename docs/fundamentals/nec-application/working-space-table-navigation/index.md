...
redirect_from:
  - /training/nec-application/working-space-table-navigation/
review:
  ...
  coverage: "Training module: Working Space and Table Navigation — worked as education, not a code determination; the AHJ and enforceable edition govern."
...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/nec-application/nec-code-reading/' | relative_url }}">&larr; NEC Code Reading Fundamentals</a>
  <a href="{{ '/fundamentals/nec-application/' | relative_url }}">↑ NEC for Machines and Panels</a>
  <a href="{{ '/fundamentals/nec-application/motor-panel-code-application/' | relative_url }}">Motor and Panel Code Application &rarr;</a>
</div>

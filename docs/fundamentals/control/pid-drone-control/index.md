...
review:
  ...
  coverage: "Training module: PID in Drone and Motion Control — educational treatment; verify design decisions against the governing standards."
...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/control/pid-heater-control/' | relative_url }}">&larr; PID Heater Control</a>

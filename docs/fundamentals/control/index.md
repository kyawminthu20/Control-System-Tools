...
- [Control Theory Overview]({{ '/fundamentals/control/control-theory-overview/' | relative_url }}) — the full control-engineering workflow before going deep on PID
- [PID Control — Intuitive Foundation]({{ '/fundamentals/control/pid-foundation/' | relative_url }}) — PID as a reading guide and concept map
- [PID Intuition — P, I, and D in Practice]({{ '/fundamentals/control/pid-intuition/' | relative_url }}) — build intuition for each term without heavy math

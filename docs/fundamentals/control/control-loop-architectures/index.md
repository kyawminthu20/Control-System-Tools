...
review:
  ...
  coverage: "Training module: Industrial Control Loop Architectures — educational treatment; verify design decisions against the governing standards."
...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/control/industrial-pid/' | relative_url }}">&larr; Industrial PID Implementation</a>
  <a href="{{ '/fundamentals/control/' | relative_url }}">↑ Control Systems</a>
  <a href="{{ '/fundamentals/control/pid-heater-control/' | relative_url }}">PID Heater Control with Contactor &rarr;</a>
</div>

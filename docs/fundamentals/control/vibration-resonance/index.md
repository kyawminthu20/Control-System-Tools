...
review:
  ...
  coverage: "Training module: Vibration and Resonance in Control Systems — educational treatment; verify design decisions against the governing standards."
...
- [Servo Tuning Strategy]({{ '/fundamentals/control/servo-tuning/' | relative_url }}) — loop tuning, notch filter application, and resonance in commissioning context
- [Control Loop Architectures]({{ '/fundamentals/control/control-loop-architectures/' | relative_url }}) — how filters integrate into the control loop

...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/electrical/electrical-quantities/' | relative_url }}">&larr; Electrical Quantities and Circuit Language</a>
  <a href="{{ '/fundamentals/electrical/' | relative_url }}">↑ Electrical Fundamentals</a>
  <a href="{{ '/fundamentals/electrical/kirchhoff-laws/' | relative_url }}">Kirchhoff's Laws and Systematic Analysis &rarr;</a>
</div>

...
review:
  ...
  coverage: "Training module: Electrical Equations Reference — educational treatment; verify design decisions against the governing standards."
...
<div style="display:flex; justify-content:space-between; margin-top:2rem; font-size:0.9rem;">
  <a href="{{ '/fundamentals/electrical/equivalent-circuit-methods/' | relative_url }}">&larr; Equivalent Circuit Methods</a>
  <a href="{{ '/fundamentals/electrical/' | relative_url }}">↑ Electrical Fundamentals</a>
  <a href="{{ '/fundamentals/electrical/passive-components/' | relative_url }}">Passive Components &rarr;</a>
</div>

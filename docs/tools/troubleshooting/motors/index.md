...
<div class="page-header">
  <div class="breadcrumb"><a href="{{ '/tools/troubleshooting/' | relative_url }}">Troubleshooting</a> › Motors</div>
...
| [VFD Commissioning Workflow]({{ '/lifecycle/guides/vfd-commissioning/' | relative_url }}) | Re-run commissioning steps if parameter changes are needed |
| [Servo Commissioning Workflow]({{ '/lifecycle/guides/servo-commissioning/' | relative_url }}) | Re-run servo axis steps for instability faults |

## Related Checklists

- [Motor Rotation and Overload Verification]({{ '/lifecycle/guides/commissioning-templates/motor-rotation-verification/' | relative_url }})
